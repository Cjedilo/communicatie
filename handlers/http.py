...
routes = [
    ...
    ("GET",  "/manifest.json",    page("manifest.json",    "application/manifest+json")),
    ("GET",  "/icon-192.png",     raw_file("icon-192.png", "image/png")),
    ("GET",  "/icon-512.png",     raw_file("icon-512.png", "image/png")),
